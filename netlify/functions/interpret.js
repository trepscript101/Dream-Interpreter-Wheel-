exports.handler = async function(event) {
  ...
  try {
    ...
    const styleNote = `Match the length, tone, and directness of this example exactly — two sentences, plain everyday words, no jargon, ends in one short question:\n"${exampleGood}"\nNever mention whether detail was or wasn't given. Never say "psyche," "your system," "in its purest form," or "worth noting." Be simple and intelligent, not padded or vague. Commit to one meaning — no hedging.`;
